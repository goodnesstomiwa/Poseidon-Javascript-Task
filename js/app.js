...
document.querySelector('.card-header').style.color = "#00FFFF";
...
const wordBlanks = `Those breed of ${myNoun}s are usually very ${myAdjective}. One ${myVerb} very ${myAdverb} past my house recently`; 
